...
Create table [dbo].[Baggage](
	[id] [int] IDENTITY(1,1) primary key NOT NULL ,
	[carryon_bag] [int] NOT NULL,--7
	[signed_luggage] [int] NOT NULL,--0
...
select * from [dbo].[Seats] where flight_schedules_id = 18 and (seat = 1 or seat = 13 or seat = 29)
...
DBCC LOG ('SkyWaveAirlinesSystem', 1);