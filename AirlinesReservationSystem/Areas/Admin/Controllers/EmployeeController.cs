...
namespace AirlinesReservationSystem.Areas.Admin.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        {
            return View(db.Admin.Where(x => x.user_type == 0).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "id,name,email,cccd,address,phone_number,password,user_type")] Models.Admin user)
        {
            var emailExit = db.Admin.FirstOrDefault(u => u.email == user.email);
            if (emailExit != null)
            {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            Models.Admin user = db.Admin.Find(id);
            if (user == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,email,cccd,address,phone_number,password,user_type")] Models.Admin user)
        {
            //old 
            Models.Admin emailExit = db.Admin.FirstOrDefault(u => u.email == user.email);
            //new 
            Models.Admin emailOld = db.Admin.Find(user.id);
        ...
        public ActionResult Delete(int? id)
        {
            ...
            Models.Admin emp = db.Admin.Find(id);
            if (emp == null)
            {
                return HttpNotFound();
            }
